...
class UserType(models.TextChoices):
    """
    User type choices for different account types
    """
...
class BuyerProfile(models.Model):
    ...
    Responsibility: Buyer-specific data and preferences
...
class SellerProfile(models.Model):
    ...
    Responsibility: Seller-specific data and business information
    - Business details
    - Seller metrics
    - Store preferences
    """
...
class AdminProfile(models.Model):
    ...
    Responsibility: Admin-specific data and permissions
